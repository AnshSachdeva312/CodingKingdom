...
const Page13 = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      THEN I WAS PARTICIPATING IN A COMPETITION AND I FELL OFF MY SKATEBOARD. EVER SINCE THEN, NOTHING HAS BEEN GOOD. THE FALL MUST HAVE TRIGGERED IT—MURPHY'S LAW SEEMED TO FOLLOW ME FROM THAT MOMENT ON, AND NOTHING EVER WENT RIGHT AGAIN. IT'S BEEN ONE FAILURE AFTER ANOTHER, AND NOW I CAN'T ESCAPE IT...
      </div>
      <div ref={imageRef2} style={styles.imageContainer}>
        <img src="/images/DennisSkate.jpg" alt="Dennis1" style={styles.image} />
      </div>
