...
const Page2 = () => {
  ...
  return (
    <div style={styles.container} ref={backgroundRef}>
      ...
      DENNIS’ PARENTS HAD REACHED THEIR BREAKING POINT. AFTER WATCHING THEIR RESOURCES DRAIN AWAY DUE TO HIS ENDLESS EXPERIMENTS, THEY COULDN’T TAKE IT ANYMORE. WITH HARSH WORDS AND A FINAL DECISION, THEY MADE HIM LEAVE, HOPING HE WOULD LEARN RESPONSIBILITY
      </div>
      <div ref={imageRef2} style={styles.imageContainerLeft}>
        <img src="/images/Image2.png" alt="Dennis1" style={styles.image} />
      </div>
      <div ref={imageRef3} style={styles.imageContainerRight}>
        <img src="/images/Image3.png" alt="Dennis1" style={styles.image} />
      </div>
    </div>
  );
};
