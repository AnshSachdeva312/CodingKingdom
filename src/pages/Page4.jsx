...
const Page4 = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      HE HAD BEEN AVOIDING THE TRUTH FOR TOO LONG. ONE BILL AFTER ANOTHER PILED UP ON HIS DESK—UNPAID, OVERDUE, AND A CONSTANT REMINDER OF HIS FINANCIAL STRUGGLES. NO MATTER HOW MUCH HE TRIED TO FOCUS ON HIS WORK, THE WEIGHT OF HIS DEBT WAS NEVER FAR AWAY
      </div>
      <div ref={imageRef2} style={styles.imageContainerLeft}>
        <img src="/images/Bills.jpg" alt="Dennis1" style={styles.image} />
      </div>
    </div>
  );
};
...
const styles = {
  ...
  imageContainerLeft: {
    ...
    left: "0",
    width: "30vw",
    height: "40vh", // You can modify this for image size
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
  },
