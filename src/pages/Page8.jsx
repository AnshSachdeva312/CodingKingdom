...
const Page8 = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      A MYSTERIOUS FIGURE EMERGED FROM THE PORTAL—IT WAS DENNIS, BUT FROM A DIFFERENT TIMELINE. HIS FUTURE SELF, MATURE AND CALM, LOOKED AT HIM WITH A STEADY GAZE. 'HI,' HE SAID, 'I KNOW THIS IS HARD TO UNDERSTAND, BUT YOU NEED TO COME WITH ME. THERE’S SOMETHING IMPORTANT WE MUST CHANGE
      </div>
      <div ref={imageRef2} style={styles.imageContainerLeft}>
        <img src="/images/DennisFuture.jpg" alt="Dennis1" style={styles.image} />
      </div>
    </div>
  );
};
